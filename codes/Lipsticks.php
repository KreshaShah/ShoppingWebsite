		...
		<div class="col-md-12">
			<div class="row">
				<div class="col-md-6">
					...
					<?php
					$query = "SELECT * FROM lipsticks";
					$result = mysqli_query($connect,$query);

					while($row = mysqli_fetch_array($result)) {?>
 
					<div class="col-md-4">
						<form method="post" action="Lipsticks.php?id=<?=$row['id']?>">
				...
				<div class="col-md-6">
					...
					if(!empty($_SESSION['cart'])){
						...
						foreach($_SESSION['cart'] as $key => $value){
							...
							<td><a href= 'Lipsticks.php?action=remove&id=".$value['id']."'>
						...
						<td>
						<a href = 'Lipsticks.php?action=clearall'>
